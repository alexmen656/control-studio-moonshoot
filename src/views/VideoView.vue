        ...
        <div v-else class="overflow-y-auto"><!--flex-1 -->
            <div class="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-8 py-4">
                ...
                <div class="flex items-center justify-between">
                    <h1 class="text-xl font-medium text-gray-900 dark:text-gray-100">Video Details</h1>
                    <div class="flex items-center gap-3">
                        ...
                        <button @click="publishVideo" v-if="currentVideo?.status === 'ready'"
        ...
        <div class="p-8">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                <div class="lg:col-span-8 space-y-6">
                    ...
                    <!---<div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-3">
                            Set a custom thumbnail that stands out and captures viewers' attention.
                            <a href="#" class="text-blue-600 dark:text-blue-400 hover:underline">Learn more</a>
                        </p>
                        <div class="flex gap-4">
                            <button
                                class="flex flex-col items-center justify-center w-40 h-24 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg hover:border-gray-400 dark:hover:border-gray-500 transition-colors">
                                <svg class="w-6 h-6 text-gray-400 mb-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm12 12H4l4-8 3 6 2-4 3 6z"
                                        clip-rule="evenodd" />
                                </svg>
                                <span class="text-xs text-gray-600 dark:text-gray-400">Upload file</span>
                            </button>
                            <button
                                class="flex flex-col items-center justify-center w-40 h-24 border-2 border-gray-300 dark:border-gray-600 rounded-lg hover:border-violet-500 dark:hover:border-violet-400 transition-colors">
                                <svg class="w-6 h-6 text-gray-400 mb-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path
                                        d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                                </svg>
                                <span class="text-xs text-gray-600 dark:text-gray-400">Auto-generate</span>
                            </button>
                            <button
                                class="flex flex-col items-center justify-center w-40 h-24 border-2 border-gray-300 dark:border-gray-600 rounded-lg hover:border-violet-500 dark:hover:border-violet-400 transition-colors">
                                <svg class="w-6 h-6 text-gray-400 mb-1" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <span class="text-xs text-gray-600 dark:text-gray-400">Test & compare</span>
                            </button>
                        </div>
                    </div>
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-3">
                            Add your video to one or more playlists to help organize content for viewers.
                            <a href="#" class="text-blue-600 dark:text-blue-400 hover:underline">Learn more</a>
                        </p>
                        <select
                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 dark:focus:ring-violet-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-3">
                            This video is set as not made for children
                        </p>
                        <div
                            class="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
                            <p class="text-sm text-orange-800 dark:text-orange-200">
                                <strong>This video is set as not made for children</strong>
                            </p>
                            <p class="text-xs text-orange-700 dark:text-orange-300 mt-1">
                                Regardless of your location, you must comply with the Children's Online Privacy
                                Protection Act (COPPA) or other laws.
                                You must tell us whether your videos are made for children.
                                <a href="#" class="text-blue-600 dark:text-blue-400 hover:underline">What content is
                                    made for children?</a>
                            </p>
                        </div>
                    </div>-->
                ...
                <div class="lg:col-span-4 space-y-4">
                    <div
                        class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden sticky top-4">
                        <div class="bg-black">
                            <div class="aspect-video flex items-center justify-center">
                                <video v-if="currentVideo?.filename" controls class="w-full h-full">
                                    <source :src="`${url}/uploads/${currentVideo?.filename}`" type="video/mp4">
                                    Your browser does not support the video tag.
                                </video>
                                <div v-else class="text-center text-white">
                                    <svg class="w-12 h-12 mx-auto mb-2 opacity-50" fill="currentColor"
                                        viewBox="0 0 20 20">
                                        <path
                                            d="M2 6a2 2 0 012-2h6a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V6zM14.553 7.106A1 1 0 0014 8v4a1 1 0 00.553.894l2 1A1 1 0 0018 13V7a1 1 0 00-1.447-.894l-2 1z" />
                                    </svg>
                                    <p class="text-xs">Video preview</p>
                                </div>
                            </div>
                        </div>
                        <div class="p-4 space-y-3">
                            <div>
                                <label class="block text-xs text-gray-500 dark:text-gray-400 mb-1">Video Link</label>
                            ...
                            <div>
                                <label class="block text-xs text-gray-500 dark:text-gray-400 mb-1">Filename</label>
                          ...
                          <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                    <span :class="[
                                        ...
                                        currentVideo?.status === 'published' ? 'text-green-600 dark:text-green-400' : 'text-gray-600 dark:text-gray-400'
                                    ]">
                                        ...
                                        {{ currentVideo?.status === 'published' ? 'Public' : 'Private' }}
                                    </span>
                                </p>
                            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
                        <div class="flex items-start justify-between mb-2">
                            <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300">Captions</h3>
                            <button class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path
                                        d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
                        <div class="flex items-start justify-between mb-2">
                            <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300">End Screen</h3>
                            <button class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path
                                        d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
                        <div class="flex items-center justify-between">
                            <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300">Cards</h3>
                            <button class="text-blue-600 dark:text-blue-400 hover:underline text-xs font-medium">
                                Add
                            </button>
                        </div>
                    </div>-->
