        ...
        <div class="p-6">
            <div class="flex items-start justify-between mb-4">
                <div class="flex items-center gap-3 min-w-0 flex-1">
                    <div :class="[iconColor, 'flex-shrink-0 w-14 h-14 rounded-xl flex items-center justify-center']">
            ...
            <div v-if="connected && connected !== true" class="mb-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                <div class="flex items-center gap-2">
                    <svg class="w-4 h-4 text-green-600 dark:text-green-400 flex-shrink-0" fill="currentColor"
                        viewBox="0 0 20 20">
                    ...
                    <div class="min-w-0 flex-1">
                        <p class="text-sm font-medium text-gray-900 dark:text-gray-100 truncate">
                            {{ typeof connected === 'object' ? (connected.username || connected.channel_name ||
                                connected.name || 'Connected') : 'Connected' }}
                        </p>
                        <p v-if="typeof connected === 'object' && connected.email"
            ...
            <button v-if="!connected" @click="$emit('connect')" :class="[
